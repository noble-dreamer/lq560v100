...
static ot_void ot_common_get_pic_buf_cfg(const ot_pic_buf_attr *buf_attr, ot_vrb_calc_cfg *calc_cfg);

__inline static ot_void ot_common_get_fmap_compress_buf_cfg(const ot_pic_buf_attr *buf_attr, ot_vrb_calc_cfg *calc_cfg)
{
    ot_u32 chn_num;
    ot_u32 width, height;
    ot_u32 main_stride, main_size, y_size, c_size;

    if (calc_cfg == OT_NULL) {
        return;
    }
    if ((buf_attr == OT_NULL) || (buf_attr->width > OT_MAXI_NUM_LIMIT) || (buf_attr->height > OT_MAXI_NUM_LIMIT)) {
        (ot_void)memset_s(calc_cfg, sizeof(*calc_cfg), 0, sizeof(*calc_cfg));
        return;
    }
...
__inline static ot_void ot_common_get_tile32x4_yuv_buf_cfg(const ot_pic_buf_attr *buf_attr, ot_vrb_calc_cfg *calc_cfg)
{
    ot_u32 width, height;
    ...
    if (buf_attr->compress_mode == OT_COMPRESS_MODE_NONE) {
        calc_cfg->vrb_size = calc_cfg->main_stride * OT_ALIGN_UP(height, 4) * 2;
        return;
    }

    calc_cfg->vrb_size = calc_cfg->main_stride * OT_ALIGN_UP(height, 4);
}

__inline static ot_bool ot_common_is_pixel_format_rgb_bayer(ot_pixel_format pixel_format)
{
...
__inline static ot_u32 ot_common_get_bit_width(ot_data_bit_width bit_width)
{
    switch (bit_width) {
...
__inline static ot_u32 ot_vi_get_raw_bit_width(ot_pixel_format pixel_format)
{
    switch (pixel_format) {
...
__inline static ot_u32 ot_common_get_valid_align(ot_u32 align)
{
...
__inline static ot_void ot_common_get_raw_buf_cfg_with_compress_ratio(const ot_pic_buf_attr *buf_attr,
    ot_u32 compress_ratio, ot_vrb_calc_cfg *calc_cfg)
{
    ot_u32 width, height, bit_width;
    ot_u32 align;
    ot_u32 stride = 0;
    ot_u32 size = 0;
    ot_u32 raw_compress_ratio;
...
__inline static ot_void ot_common_get_raw_buf_cfg(const ot_pic_buf_attr *buf_attr, ot_vrb_calc_cfg *calc_cfg)
{
    /* use default frame compress ratio */
    ot_common_get_raw_buf_cfg_with_compress_ratio(buf_attr, 0, calc_cfg);
}

__inline static ot_bool ot_common_is_pixel_format_package_422(ot_pixel_format pixel_format)
{
...
__inline static ot_void ot_common_get_uncompressed_yuv_buf_cfg(const ot_pic_buf_attr *buf_attr,
    ot_vrb_calc_cfg *calc_cfg)
{
    ot_u32 align_height, bit_width, size, y_size;
    ot_u32 align, stride;
    ...
    if ((buf_attr->pixel_format == OT_PIXEL_FORMAT_YVU_SEMIPLANAR_420) ||
        ...
        size = y_size >> 1;
    } else if (ot_common_is_pixel_format_package_422(buf_attr->pixel_format) == OT_TRUE) {
        stride *= 2;
        size = y_size * 2;
    } else {
        size = y_size * 3;
...
__inline static ot_u32 ot_common_get_yuv_head_stride(ot_u32 width, ot_compress_mode compress_mode)
{
...
__inline static ot_u32 ot_common_get_seg_compress_align_height_chroma(ot_u32 align_height,
...
__inline static ot_void ot_common_get_compact_seg_compress_yuv_buf_cfg(const ot_pic_buf_attr *buf_attr,
    ot_vrb_calc_cfg *calc_cfg)
{
    ot_u32 align_height, align_c_height, bit_width, head_size, head_y_size, y_size, c_size;
    ot_u32 align, head_stride, stride;
    const ot_u32 cmp_ratio_luma = OT_SEG_RATIO_8BIT_LUMA;
    const ot_u32 cmp_ratio_chroma = OT_SEG_RATIO_8BIT_CHROMA;
    ...
    calc_cfg->vrb_size     = head_size + y_size + c_size;
...
__inline static ot_void ot_common_get_seg_compress_yuv_buf_cfg(const ot_pic_buf_attr *buf_attr,
    ot_vrb_calc_cfg *calc_cfg)
{
    ot_u32 align_height, bit_width, head_size, head_y_size, size, y_size;
    ot_u32 align, head_stride, stride;
    ...
    calc_cfg->vrb_size     = head_size + size;
    calc_cfg->head_stride = head_stride;
    calc_cfg->head_size   = head_size;
    calc_cfg->head_y_size = head_y_size;
    calc_cfg->main_stride = stride;
...
__inline static ot_void ot_common_get_yuv_buf_cfg(const ot_pic_buf_attr *buf_attr, ot_vrb_calc_cfg *calc_cfg)
{
    if (calc_cfg == OT_NULL) {
        return;
    }
...
__inline static ot_u32 ot_aibnr_get_vrb_size(ot_u32 width, ot_u32 height, ot_compress_mode compress_mode)
{
    ot_pic_buf_attr buf_attr = {0};
    ot_vrb_calc_cfg calc_cfg = {0};
    ...
    return calc_cfg.vrb_size;
}

__inline static ot_u32 ot_aidrc_get_in_vrb_size(ot_u32 width, ot_u32 height, ot_compress_mode compress_mode)
{
    ot_pic_buf_attr buf_attr = {0};
    ot_vrb_calc_cfg calc_cfg = {0};
...
__inline static ot_void ot_aidrc_get_detail_buf_cfg(ot_u32 width, ot_u32 height, ot_vrb_calc_cfg *calc_cfg)
{
    ot_pic_buf_attr buf_attr = {0};
...
__inline static ot_u32 ot_aidrc_get_coef_buf_size(ot_u32 width, ot_u32 height)
{
    ot_u32 coef_size, coef_min_size;
    const ot_u32 down_sample_factor = 32;
    const ot_u32 channels = 112;
...
__inline static ot_u32 ot_ai3dnr_get_vrb_size(ot_u32 width, ot_u32 height, ot_compress_mode compress_mode)
{
    ot_pic_buf_attr buf_attr = {0};
    ot_vrb_calc_cfg calc_cfg = {0};
...
__inline static ot_bool ot_vdec_check_pic_size(ot_payload_type type, ot_u32 width, ot_u32 height)
{
...
__inline static ot_bool ot_venc_check_pic_buf_size(ot_payload_type type, const ot_venc_buf_attr *attr)
{
    ...
    if (attr->share_buf_en != OT_FALSE && attr->share_buf_en != OT_TRUE) {
        return OT_FALSE;
    }
...
__inline static ot_u32 ot_venc_get_h264_pic_buf_size(ot_payload_type type, const ot_venc_buf_attr *attr)
{
    ot_u32 y_header_stride, c_header_stride, y_stride, c_stride;
    ot_u32 y_header_size, c_header_size;
    ot_u32 y_size, c_size, y_blk_size, c_blk_size;
    ot_u32 blk_height_y, blk_height_c;
    ot_u32 width, height;
    ot_bool share_buf;
    ot_u32 frame_buf_ratio, frame_buf_ratio_y, frame_buf_ratio_c;
    ot_u32 pic_size;
...
__inline static ot_u32 ot_venc_get_h265_pic_buf_size(ot_payload_type type, const ot_venc_buf_attr *attr)
{
    ot_u32 y_header_stride, c_header_stride, y_stride, c_stride;
    ot_u32 y_header_size, c_header_size;
    ot_u32 y_size, c_size, y_blk_size, c_blk_size;
...
__inline static ot_bool ot_venc_is_mosaic_blk_valid(ot_u32 blk_size)
{
...
__inline static ot_void ot_common_get_fmu_align_size(ot_u32 *width, ot_u32 *height)
{
    *height = OT_ALIGN_UP(*height, 4); /* 4: height align */
    *width = OT_ALIGN_UP(*width, OT_DEFAULT_ALIGN);
}

__inline static ot_u32 ot_vi_get_fmu_wrap_page_num(ot_u32 width, ot_u32 height)
{
    const ot_u32 page_size = 0x8000; /* 0x8000, page_size */
    ot_u32 total_size;
    ot_u32 page_num;
...
__inline static ot_u32 ot_vproc_get_fmu_wrap_page_num(ot_u32 width, ot_u32 height)
{
    const ot_u32 page_size = 0x8000; /* 0x8000, page_size */
    ot_u32 y_size, c_size;
    ot_u32 y_page_num, c_page_num;
