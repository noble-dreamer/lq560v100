#ifndef __EMMC_COMMON_H__
#define __EMMC_COMMON_H__
...
#define SDHCI_BASE_ADDR                     (0x10020000)
...
#define SDHCI_INT_MASK    0xFFFFFFFFU
...
#define EMMC_RD_REG_4BYTE(reg)    (*(volatile unsigned int *)(reg))
#define EMMC_RD_REG_2BYTE(reg)    (*(volatile unsigned short *)(reg))
#define EMMC_RD_REG_BYTE(reg)    (*(volatile unsigned char *)(reg))

#define EMMC_WR_REG_4BYTE(reg, val)    (*(volatile unsigned int *)(reg) = (val))
#define EMMC_WR_REG_2BYTE(reg, val)    (*(volatile unsigned short *)(reg) = (val))
#define EMMC_WR_REG_BYTE(reg, val)    (*(volatile unsigned char *)(reg) = (val))
#endif /* __EMMC_COMMON_H__ */
