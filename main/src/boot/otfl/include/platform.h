...
#define SYS_CNT_OTFL_START_OFFSET 				3
#define SYS_CNT_UBOOT_START_OFFSET 				4

#define OTFL_STACK_SIZE						0x1000
#define BOOTROM_BSS_SIZE					0xa00
#define STACK_ADDR						(SRAM_BASE + OTFL_STACK_SIZE)
#define CP_STEP1_ADDR						(SRAM_BASE + OTFL_STACK_SIZE + BOOTROM_BSS_SIZE)
/* OTFL security reinforcement */
/* REE/TEE/TP KEY AREA */
...
/* OTFL */
#define OTFL_KEY_AREA_ADDR					(CP_STEP1_ADDR + ROOT_PUB_KEY_AREA_SIZE)
#define OTFL_KEY_AREA_SIZE					0x100
#define TP_EXT_KEY_AREA_ADDR					(OTFL_KEY_AREA_ADDR + OTFL_KEY_AREA_SIZE)
#define TP_EXT_KEY_AREA_SIZE					0x100
#define OTFL_CODE_INFO_ADDR					(TP_EXT_KEY_AREA_ADDR + TP_EXT_KEY_AREA_SIZE)
#define OTFL_CODE_INFO_SIZE					0x200
#define OTFL_CODE_AREA_ADDR					(OTFL_CODE_INFO_ADDR + OTFL_CODE_INFO_SIZE)

#define OTFL_CODE_INFO_OFFSET			    (ROOT_PUB_KEY_AREA_SIZE + OTFL_KEY_AREA_SIZE + \
									        TP_EXT_KEY_AREA_SIZE)
#define OTFL_CODE_OFFSET					(OTFL_CODE_INFO_OFFSET + OTFL_CODE_INFO_SIZE)


/* #define REE_BOOT_KEY_AREA_OFFSET            (0x00080000) */
...
#define LPDS_OTFL_KEY_AREA_HASH_ADDR          			(LPDS_CFCT_HASH_ADDR + 32)
#define LPDS_TP_EXT_KEY_AREA_HASH_ADDR       			(LPDS_OTFL_KEY_AREA_HASH_ADDR + 32)
#define LPDS_OTFL_CODE_INFO_HASH_ADDR         			(LPDS_TP_EXT_KEY_AREA_HASH_ADDR + 32)
#define LPDS_REE_KEY_AREA_HASH_ADDR          			(LPDS_OTFL_CODE_INFO_HASH_ADDR + 32)
