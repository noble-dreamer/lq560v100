...
typedef struct ot_media_memory_zone ot_smr_t;

#define OT_SMR_FMT_S        "PHYS(0x%08lX, 0x%08lX), GFP=%lu, nBYTES=%luKB,    NAME=\"%s\""
#define ot_smr_fmt_arg(p)   (p)->phys_start, (p)->phys_start + (p)->nbytes - 1, (p)->gfp, (p)->nbytes / SZ_1K, (p)->name
...
#define OT_MMB_FMT_S \
    ...
    "length=%luKB,    name=\"%s\""
#endif
#define ot_mmb_fmt_arg(p)   (p)->phys_addr, smr_grain_align((p)->phys_addr + (p)->length) - 1, \
...
#define SMR_MMB_IOC_MAGIC               'm'
#define SMR_MMB_DCACHE_DIRTY_IOC_MAGIC  'd'
#define SMR_MMB_SHARE_IOC_MAGIC         's'

typedef enum {
    OT_SMR_IOC_NR_MMB_ALLOC = 10,
    OT_SMR_IOC_NR_MMB_ATTR,
    OT_SMR_IOC_NR_MMB_FREE,

    OT_SMR_IOC_NR_MMB_USER_REMAP = 20,
    OT_SMR_IOC_NR_MMB_USER_REMAP_CACHED,
    OT_SMR_IOC_NR_MMB_USER_UNMAP,
    OT_SMR_IOC_NR_MMB_VIRT_GET_PHYS,
    OT_SMR_IOC_NR_MMB_SYS_FLUSH_CACHE,
    OT_SMR_IOC_NR_MMB_BASE_CHECK_ADDR,

    OT_SMR_IOC_NR_MMB_MEM_SHARE = 40,
    OT_SMR_IOC_NR_MMB_MEM_UNSHARE,
    OT_SMR_IOC_NR_MMB_MEM_SHARE_ALL,
    OT_SMR_IOC_NR_MMB_MEM_UNSHARE_ALL,
    OT_SMR_IOC_NR_MMB_VIRT_GET_SYS_MEM,
    OT_SMR_IOC_NR_MMB_PHYS_GET_SYS_MEM,
    OT_SMR_IOC_NR_MMB_HANDLE_GET_SYS_MEM,

    OT_SMR_IOC_NR_MMB_FLUSH_DCACHE_DIRTY = 50,

    OT_SMR_IOC_NR_BUTT
} ot_smr_ioc_nr;

#define IOC_MMB_ALLOC              _IOWR(SMR_MMB_IOC_MAGIC, OT_SMR_IOC_NR_MMB_ALLOC, struct mmb_info)
#define IOC_MMB_ATTR               _IOR(SMR_MMB_IOC_MAGIC, OT_SMR_IOC_NR_MMB_ATTR, struct mmb_info)
#define IOC_MMB_FREE               _IOW(SMR_MMB_IOC_MAGIC, OT_SMR_IOC_NR_MMB_FREE, struct mmb_info)

#define IOC_MMB_USER_REMAP         _IOWR(SMR_MMB_IOC_MAGIC, OT_SMR_IOC_NR_MMB_USER_REMAP, struct mmb_info)
#define IOC_MMB_USER_REMAP_CACHED  _IOWR(SMR_MMB_IOC_MAGIC, OT_SMR_IOC_NR_MMB_USER_REMAP_CACHED, struct mmb_info)
#define IOC_MMB_USER_UNMAP         _IOWR(SMR_MMB_IOC_MAGIC, OT_SMR_IOC_NR_MMB_USER_UNMAP, struct mmb_info)
#define IOC_MMB_VIRT_GET_PHYS      _IOWR(SMR_MMB_IOC_MAGIC, OT_SMR_IOC_NR_MMB_VIRT_GET_PHYS, struct mmb_info)
#define IOC_MMB_SYS_FLUSH_CACHE    _IOW(SMR_MMB_IOC_MAGIC, OT_SMR_IOC_NR_MMB_SYS_FLUSH_CACHE, struct mmb_info)
#define IOC_MMB_BASE_CHECK_ADDR    _IOW(SMR_MMB_IOC_MAGIC, OT_SMR_IOC_NR_MMB_BASE_CHECK_ADDR, struct mmb_info)

#define IOC_MMB_MEM_SHARE          _IOW(SMR_MMB_SHARE_IOC_MAGIC, OT_SMR_IOC_NR_MMB_MEM_SHARE, \
                                        struct mmb_share_info)
#define IOC_MMB_MEM_UNSHARE        _IOW(SMR_MMB_SHARE_IOC_MAGIC, OT_SMR_IOC_NR_MMB_MEM_UNSHARE, \
                                        struct mmb_share_info)
#define IOC_MMB_MEM_SHARE_ALL      _IOW(SMR_MMB_SHARE_IOC_MAGIC, OT_SMR_IOC_NR_MMB_MEM_SHARE_ALL, \
                                        struct mmb_share_info)
#define IOC_MMB_MEM_UNSHARE_ALL    _IOW(SMR_MMB_SHARE_IOC_MAGIC, OT_SMR_IOC_NR_MMB_MEM_UNSHARE_ALL, \
                                        struct mmb_share_info)
#define IOC_MMB_VIRT_GET_SYS_MEM   _IOWR(SMR_MMB_SHARE_IOC_MAGIC, OT_SMR_IOC_NR_MMB_VIRT_GET_SYS_MEM, \
                                         struct mmb_share_info)
#define IOC_MMB_PHYS_GET_SYS_MEM   _IOWR(SMR_MMB_SHARE_IOC_MAGIC, OT_SMR_IOC_NR_MMB_PHYS_GET_SYS_MEM, \
                                         struct mmb_share_info)
#define IOC_MMB_HANDLE_GET_SYS_MEM _IOWR(SMR_MMB_SHARE_IOC_MAGIC, OT_SMR_IOC_NR_MMB_HANDLE_GET_SYS_MEM, \
                                         struct mmb_share_info)

#define IOC_MMB_FLUSH_DCACHE_DIRTY _IOW(SMR_MMB_DCACHE_DIRTY_IOC_MAGIC, OT_SMR_IOC_NR_MMB_FLUSH_DCACHE_DIRTY, \
                                        struct dirty_area)

#define SMR_SETUP_CMDLINE_LEN      256
typedef struct {
    char smr[SMR_SETUP_CMDLINE_LEN];
    char map_smr[SMR_SETUP_CMDLINE_LEN];
    int anony;
} smr_module_params_s;
