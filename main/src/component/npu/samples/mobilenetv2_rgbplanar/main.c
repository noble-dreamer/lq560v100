...
int main(int argc, char** argv) {
...
#if defined(_WIN32)
    const char* model_path = "..\\mobilenetv2_rgbplanar_s.ortm";
    const char* input_path = "..\\ILSVRC2012_val_00024327.bin";
#else
    const char* model_path = "mobilenetv2_rgbplanar_s.ortm";
    const char* input_path = "ILSVRC2012_val_00024327.rgb";
#endif
#else
    ot_avp_npu_config config = {
        .core_ids = 0,
...
#endif
    ot_smr_init();
    const char* model_path = "../data/model/classification/mobilenetv2_rgbplanar_b.ortm";
    const char* input_path = "../data/ImageNet/rgbplanar/ILSVRC2012_val_00024327.rgb";
#endif
    printf("mobilenetv2 sample start\n");
    ...
    ot_avp_npu_shape input_shape, output_shape;
