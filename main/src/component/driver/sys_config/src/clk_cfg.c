...
void i2c_clk_cfg(void)
{
    ...
    /* I2C */
    sys_writel(crg_base + 0x4280, 0x1010); /* i2c0 reset&cken 100M */
    sys_writel(crg_base + 0x4288, 0x1010); /* i2c1 reset&cken 100M */
    sys_writel(crg_base + 0x4290, 0x1010); /* i2c2 reset&cken 100M */
    sys_writel(crg_base + 0x4298, 0x1010); /* i2c3 reset&cken 100M */
    sys_writel(crg_base + 0x42a0, 0x1010); /* i2c4 reset&cken 100M */
    sys_writel(crg_base + 0x42a8, 0x1010); /* i2c5 reset&cken 100M */
    sys_writel(crg_base + 0x42b0, 0x1010); /* i2c6 reset&cken 100M */
    sys_writel(crg_base + 0x42b8, 0x1010); /* i2c7 reset&cken 100M */
}
