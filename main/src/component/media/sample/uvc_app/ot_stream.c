...
static struct ot_stream g_ot_stream = {
    ...
    .mpi_xu_ops = NULL,
    .streaming = {0},
    .exposure_auto_stall = OT_FALSE,
    .brightness_stall = OT_FALSE,
    .contrast_auto_stall = OT_FALSE,
    .hue_auto_stall = OT_FALSE,
    .white_balance_component_auto_stall = OT_FALSE,
};
...
int ot_stream_startup(ot_u32 dev_no)
{
    int ret = 0;
...
int ot_stream_shutdown(ot_u32 dev_no)
{
    int ret = 0;
...
int ot_stream_set_enc_property(ot_u32 dev_no, struct encoder_property *p)
{
...
int ot_stream_set_enc_idr(ot_u32 dev_no)
{
...
int ot_stream_get_venc_send_uvc(ot_u32 dev_no)
{
