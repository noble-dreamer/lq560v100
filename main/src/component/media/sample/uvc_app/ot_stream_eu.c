...
static void ot_stream_eu_profile_toolset_ctrl(struct ot_uvc_dev *dev, uint8_t req, struct uvc_request_data *resp)
{
    ...
    switch (req) {
        case OT_UVC_SET_CUR:
            ...
            break;
        case OT_UVC_GET_CUR:
            (ot_void)memcpy_s(resp->data, sizeof(resp->data), &v, sizeof(uint64_t));
            resp->length = OT_UVC_RESP_LENGTH_5;
            break;
        case OT_UVC_GET_DEF:
            resp->data[0] = 0x4;
...
static void ot_stream_eu_min_frame_interval_ctrl(struct ot_uvc_dev *dev, uint8_t req, struct uvc_request_data *resp)
{
    ...
    switch (req) {
        case OT_UVC_SET_CUR:
            ...
            break;
        case OT_UVC_GET_CUR:
            (ot_void)memcpy_s(resp->data, sizeof(resp->data), &v, sizeof(uint32_t));
            resp->length = OT_UVC_RESP_LENGTH_WORD;
            break;
        case OT_UVC_GET_MIN:
            resp->data[0] = 0x0;
...
static void ot_stream_eu_quantization_params_ctrl(struct ot_uvc_dev *dev, uint8_t req, struct uvc_request_data *resp)
{
    ...
    switch (req) {
        case OT_UVC_SET_CUR:
            ...
            break;
        case OT_UVC_GET_CUR:
            (ot_void)memcpy_s(resp->data, OT_UVC_RESP_LENGTH_6, &v, OT_UVC_RESP_LENGTH_6);
            resp->length = OT_UVC_RESP_LENGTH_6;
            break;
        case OT_UVC_GET_MIN:
            resp->data[0] = 0x0;
...
static void ot_stream_eu_ltr_buffer_ctrl(struct ot_uvc_dev *dev, uint8_t req, struct uvc_request_data *resp)
{
    ...
    switch (req) {
        case OT_UVC_SET_CUR:
            ...
            break;
        case OT_UVC_GET_CUR:
            (ot_void)memcpy_s(resp->data, sizeof(resp->data), &v, sizeof(uint16_t));
            resp->length = OT_UVC_RESP_LENGTH_HALF_WORD;
            break;
        case OT_UVC_GET_MIN:
            resp->data[0] = 0x0;
...
static void ot_stream_eu_sei_payloadtype_set(struct ot_uvc_dev *dev, const struct uvc_request_data *data)
{
    ...
    (ot_void)memcpy_s(&v, sizeof(uint64_t), data->data, sizeof(uint64_t));
