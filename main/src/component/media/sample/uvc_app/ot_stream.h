...
typedef struct stream_control_ops {
    int (*init)(void);
    int (*deinit)(void);
    int (*startup)(ot_u32 dev_no);
    int (*shutdown)(ot_u32 dev_no);
    int (*set_idr)(ot_u32 dev_no);
    int (*set_property)(ot_u32 dev_no, struct encoder_property *p);
    int (*get_send)(ot_u32 dev_no);
...
typedef struct ot_stream {
    ...
    ot_bool exposure_auto_stall;
    ot_bool brightness_stall;
    ot_bool contrast_auto_stall;
    ot_bool hue_auto_stall;
    ot_bool gamma_stall;
    ot_bool white_balance_component_auto_stall;
} ot_stream;
...
extern int ot_stream_set_enc_property(ot_u32 dev_no, struct encoder_property *p);
extern int ot_stream_init(void);
extern int ot_stream_deinit(void);
extern int ot_stream_shutdown(ot_u32 dev_no);
extern int ot_stream_startup(ot_u32 dev_no);
extern int ot_stream_set_enc_idr(ot_u32 dev_no);
extern int ot_stream_get_venc_send_uvc(ot_u32 dev_no);
