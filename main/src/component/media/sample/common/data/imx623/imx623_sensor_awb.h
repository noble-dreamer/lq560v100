...
#ifndef IMX623_SENSOR_AWB_H
#define IMX623_SENSOR_AWB_H
...
static const ot_eis_vi_awb_sensor_default g_imx623_awb_cmos =
{
    4950, /* wb_ref_temp */
    ...
    {0, 0, 0, 0, 0}, /* init_ccm */
    {
        0, /* preawb_attr_enable */
        0, /* preawb_attr reverse enable */
        {0, 0, 0}, /* preawb_attr_color_temp_array */
        {0, 0, 0}, /* preawb_attr_ratio_r_array */
        {0, 0, 0}, /* preawb_attr_ratio_b_array */
    },
};
