...
__inline static ot_void ot_common_get_pic_buf_cfg(const ot_pic_buf_attr *buf_attr, ot_vrb_calc_cfg *calc_cfg)
{
    if (calc_cfg == OT_NULL) {
        return;
    }
    ...
    /* linear, raw */
    if (ot_common_is_pixel_format_rgb_bayer(buf_attr->pixel_format) == OT_TRUE) {
...
__inline static ot_u32 ot_common_get_pic_buf_size(const ot_pic_buf_attr *buf_attr)
{
...
__inline static ot_void ot_vi_get_raw_buf_cfg_with_compress_ratio(const ot_pic_buf_attr *buf_attr,
    ot_u32 compress_ratio, ot_vrb_calc_cfg *calc_cfg)
{
    if (calc_cfg == OT_NULL) {
        return;
    }
    if ((buf_attr == OT_NULL) || (buf_attr->compress_mode != OT_COMPRESS_MODE_FRAME)) {
        (ot_void)memset_s(calc_cfg, sizeof(*calc_cfg), 0, sizeof(*calc_cfg));
        return;
    }
...
__inline static ot_u32 ot_aibnr_get_pic_buf_size(ot_u32 width, ot_u32 height)
{
    ot_u32 compress_none_buf_size, compress_line_buf_size;

    if ((width > OT_MAXI_NUM_LIMIT) || (height > OT_MAXI_NUM_LIMIT)) {
        return 0;
    }

    compress_none_buf_size = ot_aibnr_get_vrb_size(width, height, OT_COMPRESS_MODE_NONE);
    compress_line_buf_size = ot_aibnr_get_vrb_size(width, height, OT_COMPRESS_MODE_LINE);

    return MAX2(compress_none_buf_size, compress_line_buf_size);
}

__inline static ot_u32 ot_aidrc_get_in_buf_size(ot_u32 width, ot_u32 height)
{
    ot_u32 compress_none_buf_size, compress_line_buf_size;
    ...
    compress_none_buf_size = ot_aidrc_get_in_vrb_size(width, height, OT_COMPRESS_MODE_NONE);
    compress_line_buf_size = ot_aidrc_get_in_vrb_size(width, height, OT_COMPRESS_MODE_FMAP);

    return MAX2(compress_none_buf_size, compress_line_buf_size);
}

__inline static ot_u32 ot_aidrc_get_out_buf_size(ot_u32 width, ot_u32 height, ot_bool advanced_mode)
{
    ...
    if (advanced_mode == OT_FALSE) {
        return calc_cfg.vrb_size;
    }

    return calc_cfg.vrb_size + ot_aidrc_get_coef_buf_size(width, height);
}

__inline static ot_u32 ot_ai3dnr_get_pic_buf_size(ot_u32 width, ot_u32 height)
{
    ot_u32 buf_size;
    ...
    buf_size = ot_ai3dnr_get_vrb_size(width, height, OT_COMPRESS_MODE_NONE);

    return buf_size;
}

__inline static ot_u32 ot_vdec_get_pic_buf_size(ot_payload_type type, const ot_pic_buf_attr *buf_attr)
{
    ...
    if (ot_vdec_check_pic_size(type, buf_attr->width, buf_attr->height) == OT_FALSE) {
        return 0;
    }
...
__inline static ot_u32 ot_vdec_get_tmv_buf_size(ot_payload_type type, ot_u32 width, ot_u32 height)
{
    ot_u32 width_in_mb, height_in_mb;
    ot_u32 col_mb_size;
    ot_u32 size;

    if (ot_vdec_check_pic_size(type, width, height) == OT_FALSE) {
        return 0;
    }
...
__inline static ot_u32 ot_venc_get_pic_buf_size(ot_payload_type type, const ot_venc_buf_attr *attr)
{
    if (ot_venc_check_pic_buf_size(type, attr) == OT_FALSE) {
        return 0;
    }
...
__inline static ot_u32 ot_venc_get_pic_info_buf_size(ot_payload_type type, const ot_venc_buf_attr *attr)
{
    ot_u32 pic_info_size;
    ot_u32 tmv_size, pme_stride, pme_size, pme_info_size;
    ot_u32 width, height;
...
__inline static ot_u32 ot_venc_get_qpmap_stride(ot_u32 width)
{
...
__inline static ot_u32 ot_venc_get_qpmap_size(ot_payload_type type, ot_u32 width, ot_u32 height)
{
    ot_u32 stride, align_height;
...
__inline static ot_u32 ot_venc_get_skip_weight_stride(ot_payload_type type, ot_u32 width)
{
    ot_u32 stride;
...
__inline static ot_u32 ot_venc_get_skip_weight_size(ot_payload_type type, ot_u32 width, ot_u32 height)
{
    ot_u32 stride, align_height;
...
__inline static ot_u32 ot_venc_get_roimap_stride(ot_payload_type type, ot_u32 width)
{
    ot_u32 stride;
...
__inline static ot_u32 ot_venc_get_roimap_size(ot_payload_type type, ot_u32 width, ot_u32 height)
{
    ot_u32 stride, align_height;
...
__inline static ot_u32 ot_venc_get_mosaic_map_stride(ot_u32 width, ot_u32 blk_size)
{
    ot_u32 blk_width;
...
__inline static ot_u32 ot_venc_get_mosaic_map_size(ot_u32 width, ot_u32 height, ot_u32 blk_size)
{
    ot_u32 stride, blk_height;
...
__inline static ot_u32 ot_vproc_get_mcf_color_buf_size(ot_u32 width, ot_u32 height)
{
    ot_u32 stride;
    ot_u32 size;
...
__inline static ot_u32 ot_vproc_get_mcf_mono_buf_size(ot_u32 width, ot_u32 height)
{
    ot_u32 stride;
    ot_u32 size;
...
__inline static ot_u32 ot_gdc_get_lut_buf_stride(ot_u32 width, ot_lut_cell_size cell_size)
{
    ot_u32 stride;
...
__inline static ot_u32 ot_common_get_fmu_wrap_page_num(ot_fmu_id id, ot_u32 width, ot_u32 height)
{
    switch (id) {
        case OT_FMU_ID_VI: {
            return 0;
        }
        case OT_FMU_ID_VPROC: {
            return ot_vproc_get_fmu_wrap_page_num(width, height);
        }
        default: {
            return 0;
        }
