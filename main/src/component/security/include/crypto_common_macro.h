...
#define crypto_cpu_to_be32(v) ((((ot_u32)(v))>>24) | ((((ot_u32)(v))>>8)&0xff00) \
                     | ((((ot_u32)(v))<<8)&0xff0000) | (((ot_u32)(v))<<24))

#define crypto_max(a, b)    ((a) > (b)) ? (a) : (b)
#define crypto_min(a, b)    ((a) > (b)) ? (b) : (a)

#ifndef crypto_unused
#define crypto_unused(x)    (ot_void)(x)
#endif

#define crypto_array_size(arr)  (sizeof(arr) / sizeof((arr)[0]))

#define crypto_reg_read(reg_addr)               (*(volatile ot_u32 *)(uintptr_t)(reg_addr))
#define crypto_reg_write(reg_addr, value)       (*(volatile ot_u32 *)(uintptr_t)(reg_addr) = (value))
...
#define crypto_check_param_null(err_level, module, _val) do { \
    crypto_check_param(err_level, module, ((_val) == OT_NULL), ERROR_PARAM_IS_NULL); \
} while (0)
#endif
