...
typedef struct {
    ot_u8 *key;
    ot_u32 key_len;
    ot_crypto_handle drv_keyslot_crypto_handle;
...
typedef struct {
    ot_u32 length[2];
    ot_u32 state[CRYPTO_HASH_RESULT_SIZE_MAX_IN_WORD];
    ot_u32 tail_len;
    crypto_hash_type hash_type;
    ot_u8 o_key_pad[CRYPTO_HASH_BLOCK_SIZE_MAX];
    ot_u8 i_key_pad[CRYPTO_HASH_BLOCK_SIZE_MAX];
    ot_u8 tail[CRYPTO_HASH_BLOCK_SIZE_MAX];
