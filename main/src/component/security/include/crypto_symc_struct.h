...
typedef struct {
    ot_u32 clear_header_len;
    ot_u32 payload_len;
    ot_u32 payload_pattern_encrypt_len;
    ot_u32 payload_pattern_clear_len;
    ot_u32 payload_pattern_offset_len;
    ot_bool iv_change;
    ot_u32 iv[CRYPTO_AES_IV_SIZE_IN_WORD];
} crypto_symc_cenc_subsample;

typedef struct {
    ot_bool use_odd_key;
    ot_u32 first_encrypt_offset;
    crypto_symc_cenc_subsample *subsample;
    ot_u32 subsample_num;
    crypto_symc_alg alg;
    crypto_symc_work_mode work_mode;
    ot_u32 iv[CRYPTO_AES_IV_SIZE_IN_WORD];
...
typedef struct {
    ...
    ot_u32 aad_len;         /* Addition Data Length In Bytes. */
    ot_u32 data_len;        /* Crypto Data Length In Bytes. */
    ot_u32 tag_len;         /* Tag Length In Bytes. */
...
typedef struct {
    ...
    ot_u8 iv[CRYPTO_IV_LEN_IN_BYTES];
    ot_u32 iv_length;
    ot_void *param;
} crypto_symc_ctrl_t;

typedef struct {
    ot_u32 chn_id;                                         /* Channel number */
    ot_u32 open;                                           /* Open or closed */
    ot_u32 is_decrypt;                                     /* Decrypt or encrypt */
    ot_u32 alg;                                            /* Algorithm */
    ot_u32 mode;                                           /* Work mode */
    ot_u32 key_len;                                        /* Key length */
    ot_u32 key_source;                                     /* Hard or soft key */
    ot_u32 int_raw;                                        /* Raw intertupt */
    ot_u32 int_en;                                         /* Enable interrupt */
    ot_u32 int_status;                                     /* Status interrupt */
    ot_u32 owner;                                          /* Process PID of owner */
    ot_u32 is_secure;                                      /* Secure channel or not */
    ot_u32 smmu_enable;                                    /* Smmu enable */
    ot_u32 in_node_head;                                   /* In node list head */
    ot_u32 in_node_rptr;                                   /* In node list read index */
    ot_u32 in_node_wptr;                                   /* In node list write index */
    ot_u32 in_node_depth;                                  /* In node depth */
    ot_u32 out_node_head;                                  /* Out node list head */
    ot_u32 out_node_rptr;                                  /* Out node list read index */
    ot_u32 out_node_wptr;                                  /* Out node list write index */
    ot_u32 out_node_depth;                                 /* Out node depth */
    ot_u8 iv[CRYPTO_AES_IV_SIZE + CRYPTO_AES_IV_SIZE + 1]; /* Out iv */
} crypto_symc_proc_info;

typedef struct {
    ot_u32 allow_reset; /* allow reset CPU or not */
    ot_u32 sec_cpu;     /* secure CPU or not */
    const char *name;   /* interrupt name */
    ot_u32 int_num;     /* interrupt number */
    ot_u32 int_en;      /* interrupt enable */
    ot_u32 smmu_base;   /* smmu base address */
    ot_u32 err_code;    /* error code */
