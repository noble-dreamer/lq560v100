...
#ifndef ADDR_H32
#define ADDR_H32(addr) (addr).word[1] /* !<  High 32 bit of ot_u64 */
#endif
#ifndef ADDR_L32
#define ADDR_L32(addr) (addr).word[0] /* !<  Low 32 bit of ot_u64 */
#endif
#ifndef ADDR_U64
#define ADDR_U64(addr) (addr).phy     /* !<  64 bit of ot_u64 */
#endif
#ifndef ADDR_VIA
