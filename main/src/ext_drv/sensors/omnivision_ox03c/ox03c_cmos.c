...
#define OX03C_ID                    3
#define SENSOR_OX03C_WIDTH          1920
#define SENSOR_OX03C_HEIGHT         1280

#define OX03C_RATIO                 64
...
#define OX03C_AWB_REVERSE                    (0x5003)
#define OX03C_SPD_B_GAIN_H                   (0x5680)
#define OX03C_SPD_B_GAIN_L                   (0x5681)
#define OX03C_SPD_GB_GAIN_H                  (0x5682)
#define OX03C_SPD_GB_GAIN_L                  (0x5683)
#define OX03C_SPD_GR_GAIN_H                  (0x5684)
#define OX03C_SPD_GR_GAIN_L                  (0x5685)
#define OX03C_SPD_R_GAIN_H                   (0x5686)
#define OX03C_SPD_R_GAIN_L                   (0x5687)
#define OX03C_nCT_H                          (0x5B76)
#define OX03C_nCT_L                          (0x5B77)

#define OX03C_HCG_B_GAIN_H                   (0x5280)
#define OX03C_HCG_B_GAIN_L                   (0x5281)
#define OX03C_HCG_GB_GAIN_H                  (0x5282)
#define OX03C_HCG_GB_GAIN_L                  (0x5283)
#define OX03C_HCG_GR_GAIN_H                  (0x5284)
#define OX03C_HCG_GR_GAIN_L                  (0x5285)
#define OX03C_HCG_R_GAIN_H                   (0x5286)
#define OX03C_HCG_R_GAIN_L                   (0x5287)

#define OX03C_LCG_B_GAIN_H                   (0x5480)
#define OX03C_LCG_B_GAIN_L                   (0x5481)
#define OX03C_LCG_GB_GAIN_H                  (0x5482)
#define OX03C_LCG_GB_GAIN_L                  (0x5483)
#define OX03C_LCG_GR_GAIN_H                  (0x5484)
#define OX03C_LCG_GR_GAIN_L                  (0x5485)
#define OX03C_LCG_R_GAIN_H                   (0x5486)
#define OX03C_LCG_R_GAIN_L                   (0x5487)

#define OX03C_VS_B_GAIN_H                    (0x5880)
#define OX03C_VS_B_GAIN_L                    (0x5881)
#define OX03C_VS_GB_GAIN_H                   (0x5882)
#define OX03C_VS_GB_GAIN_L                   (0x5883)
#define OX03C_VS_GR_GAIN_H                   (0x5884)
#define OX03C_VS_GR_GAIN_L                   (0x5885)
#define OX03C_VS_R_GAIN_H                    (0x5886)
#define OX03C_VS_R_GAIN_L                    (0x5887)

/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/
#define ox03c_sensor_set_ctx(pipe, ctx)   ((g_ox03c_sns_state[pipe]) = (ctx))
#define ox03c_sensor_reset_ctx(pipe)      (g_ox03c_sns_state[pipe] = OT_NULL)
...
ot_eis_sns_bus_info g_ox03c_bus_info[OT_EIS_VI_MAX_PIPE_NUM] = {
        [0] = {
            .com_bus.i2c_dev = 0,
            .bus_addr = OX03C_I2C_ADDR
        },
...
ot_eis_sns_state *g_ox03c_sns_state[OT_EIS_VI_MAX_PIPE_NUM] = {OT_NULL};
...
{
    return &g_ox03c_bus_info[vi_pipe];
}

ot_eis_sns_state *ox03c_get_ctx(ot_vi_pipe_id vi_pipe)
{
    return g_ox03c_sns_state[vi_pipe];
}
...
const ox03c_video_mode_tbl g_ox03c_mode_tbl[OX03C_MODE_BUTT] = {
    {OX03C_VMAX_1280P30_LINEAR,   OX03C_FULL_LINES_MAX,          30, 0.8,
     1920, 1280, 0, OT_EIS_WDR_MODE_NONE,       "OX03C_SENSOR_1280P_30FPS_LINEAR_MODE"},
    {OX03C_VMAX_1280P90TO30_WDR,  OX03C_FULL_LINES_MAX_BUILT_IN_WDR, 60, 0.5,
     1920, 1280, 0, OT_EIS_WDR_MODE_BUILT_IN,  "OX03C_SENSOR_1280P_30FPS_WDR_built_in_MODE"},
};

/****************************************************************************
 * local variables                                                            *
 ****************************************************************************/
/* OX03C Register Address */
#define OX03C_SHT_DCG_H                       (0x3501) /*  SHT_DCG[15:8]  */
#define OX03C_SHT_DCG_L                       (0x3502) /*  SHT_DCG[7:0]  */
#define OX03C_SHT_SPD_H                       (0x3541) /*  SHT_SPD[15:8]  */
#define OX03C_SHT_SPD_L                       (0x3542) /*  SHT_SPD[7:0]  */
#define OX03C_SHT_VS_H                        (0x35c1) /*  SHT_VS[15:8]  */
#define OX03C_SHT_VS_L                        (0x35c2) /*  SHT_VS[7:0]  */

#define OX03C_AGAIN_HCG_H                     (0x3508) /*  AGAIN_HCG_H[7:4]   REG[3:0]*/
#define OX03C_AGAIN_HCG_L                     (0x3509) /*  AGAIN_HCG_H[3:0]   REG[7:4]*/
#define OX03C_AGAIN_LCG_H                     (0x3588) /*  AGAIN_LCG_H[7:4]   REG[3:0]*/
#define OX03C_AGAIN_LCG_L                     (0x3589) /*  AGAIN_LCG_H[3:0]   REG[7:4]*/
#define OX03C_AGAIN_SPD_H                     (0x3548) /*  AGAIN_SPD_H[7:4]   REG[3:0]*/
#define OX03C_AGAIN_SPD_L                     (0x3549) /*  AGAIN_SPD_H[3:0]   REG[7:4]*/
#define OX03C_AGAIN_VS_H                      (0x35c8) /*  AGAIN_VS_H[7:4]   REG[3:0]*/
#define OX03C_AGAIN_VS_L                      (0x35c9) /*  AGAIN_VS_H[3:0]   REG[7:4]*/

#define OX03C_DGAIN_HCG_H                     (0x350A) /*  DGAIN_HCG_H[13:10]  REG[3:0]*/
#define OX03C_DGAIN_HCG_M                     (0x350B) /*  DGAIN_HCG_M[9:2]   REG[7:0]*/
#define OX03C_DGAIN_HCG_L                     (0x350C) /*  DGAIN_HCG_L[1:0]   REG[7:6]*/
#define OX03C_DGAIN_LCG_H                     (0x358A) /*  DGAIN_LCG_H[13:10]  REG[3:0]*/
#define OX03C_DGAIN_LCG_M                     (0x358B) /*  DGAIN_LCG_M[9:2]   REG[7:0]*/
#define OX03C_DGAIN_LCG_L                     (0x358C) /*  DGAIN_LCG_L[1:0]   REG[7:6]*/
#define OX03C_DGAIN_SPD_H                     (0x354A) /*  DGAIN_SPD_H[13:10]  REG[3:0]*/
#define OX03C_DGAIN_SPD_M                     (0x354B) /*  DGAIN_SPD_M[9:2]   REG[7:0]*/
#define OX03C_DGAIN_SPD_L                     (0x354C) /*  DGAIN_SPD_L[1:0]   REG[7:6]*/

#define OX03C_DGAIN_VS_H                      (0x35CA) /*  DGAIN_VS_H[13:10]  REG[3:0]*/
#define OX03C_DGAIN_VS_M                      (0x35CB) /*  DGAIN_VS_M[9:2]   REG[7:0]*/
#define OX03C_DGAIN_VS_L                      (0x35CC) /*  DGAIN_VS_L[1:0]   REG[7:6]*/



#define OX03C_VMAX_H                           (0x380e) /*  VMAX_H[15:8]   REG[7:0]*/
#define OX03C_VMAX_L                           (0x380f) /*  VMAX_L[7:0]   REG[7:0]*/


#define ox03c_err_mode_print(sns_image_mode, sns_state) \
do { \
    ...
    const ot_eis_sns_state *sns_state)
{
    ...
    ae_sns_dft->full_lines_max = OX03C_FULL_LINES_MAX;
...
static ot_s32 cmos_get_ae_default(ot_vi_pipe_id vi_pipe, ot_eis_vi_ae_sensor_default *ae_sns_dft)
{
    ...
    ox03c_sensor_get_ctx(vi_pipe, sns_state);
...
static ot_void cmos_fps_set(ot_vi_pipe_id vi_pipe, ot_float fps, ot_eis_vi_ae_sensor_default *ae_sns_dft)
{
    ...
    lines = g_ox03c_mode_tbl[sns_state->img_mode].ver_lines;
    lines_max = g_ox03c_mode_tbl[sns_state->img_mode].max_ver_lines;
    max_fps = g_ox03c_mode_tbl[sns_state->img_mode].max_fps;
    min_fps = g_ox03c_mode_tbl[sns_state->img_mode].min_fps;
...
#define CALIBRATE_STATIC_WB_R_GAIN                    516
#define CALIBRATE_STATIC_WB_GR_GAIN                   256
#define CALIBRATE_STATIC_WB_GB_GAIN                   256
#define CALIBRATE_STATIC_WB_B_GAIN                    474

/* Calibration results for Auto WB Planck */                       //AWB calibration
#define CALIBRATE_AWB_P1                              (44)
#define CALIBRATE_AWB_P2                              (138)
#define CALIBRATE_AWB_Q1                              (-75)
#define CALIBRATE_AWB_A1                              (588)
#define CALIBRATE_AWB_B1                              -141253
#define CALIBRATE_AWB_C1                              (18617365)
...
static ot_s32 cmos_get_awb_default(ot_vi_pipe_id vi_pipe, ot_eis_vi_awb_sensor_default *awb_sns_dft)
{
    ...
    if (g_ext_awb_flag[vi_pipe] == 1) {
        ...
        ot_u16 color_temp_array[OT_EIS_VI_AWB_PREAWB_LUT_SIZE]     = { 2300, 2800, 4000, 5000, 6500, 7500 };
        ot_u32 preawb_ratio_r_array[OT_EIS_VI_AWB_PREAWB_LUT_SIZE] = { 62540, 66746, 58660, 57689, 56597, 56117 };/* 67051, 66168, 64001, 63188, 61240, 60919 */
        ot_u32 preawb_ratio_b_array[OT_EIS_VI_AWB_PREAWB_LUT_SIZE] = { 57189, 56415, 67433, 69254, 70972, 71073 };/* 58385, 52546, 68416, 69240, 70212, 71045 */
...
static ot_s32 cmos_get_vi_alg_default(ot_vi_pipe_id vi_pipe, ot_eis_vi_sns_alg_default *isp_def)
{
    ...
    isp_def->sns_mode.sns_id = OX03C_ID;
...
static ot_void cmos_set_pixel_detect(ot_vi_pipe_id vi_pipe, ot_bool enable)
{
    ...
    if (sns_state->wdr_mode == OT_EIS_WDR_MODE_2To1_LINE) {
        ...
        if (sns_state->img_mode == OX03C_SENSOR_1280P_30FPS_LINEAR_MODE) {
            full_lines_5fps = (OX03C_VMAX_1280P30_LINEAR * 60) / 5; /* 30fps, 5fps */
        } else {
            return;
        }
    }
...
static ot_void cmos_comm_sns_reg_info_init(ot_vi_pipe_id vi_pipe, ot_eis_sns_state *sns_state)
{
    ...
    sns_state->regs_info[0].com_bus.i2c_dev = g_ox03c_bus_info[vi_pipe].com_bus.i2c_dev;
    ...
    for (i = 0; i < sns_state->regs_info[0].reg_num; i++) {
        ...
        sns_state->regs_info[0].i2c_data[i].dev_addr = g_ox03c_bus_info[vi_pipe].bus_addr;
        sns_state->regs_info[0].i2c_data[i].addr_byte_num = OX03C_ADDR_BYTE;
        sns_state->regs_info[0].i2c_data[i].data_byte_num = OX03C_DATA_BYTE;
    }
...
static ot_void cmos_built_in_sns_reg_info_init(ot_vi_pipe_id vi_pipe, ot_eis_sns_state *sns_state)
{
    ...
    sns_state->regs_info[0].i2c_data[0].reg_addr = OX03C_SHT_DCG_H;
    sns_state->regs_info[0].i2c_data[1].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[1].reg_addr = OX03C_SHT_DCG_L;
    sns_state->regs_info[0].i2c_data[2].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[2].reg_addr = OX03C_SHT_SPD_H;
    sns_state->regs_info[0].i2c_data[3].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[3].reg_addr = OX03C_SHT_SPD_L;

	// hcg gain
    sns_state->regs_info[0].i2c_data[4].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[4].reg_addr = OX03C_AGAIN_HCG_H;
    sns_state->regs_info[0].i2c_data[5].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[5].reg_addr = OX03C_AGAIN_HCG_L;

	// dgain related
    sns_state->regs_info[0].i2c_data[6].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[6].reg_addr = OX03C_DGAIN_HCG_H;
    sns_state->regs_info[0].i2c_data[7].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[7].reg_addr = OX03C_DGAIN_HCG_M;
	// lcg gain
    sns_state->regs_info[0].i2c_data[8].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[8].reg_addr = OX03C_AGAIN_LCG_H;
    sns_state->regs_info[0].i2c_data[9].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[9].reg_addr = OX03C_AGAIN_LCG_L;

	// spd gain
    sns_state->regs_info[0].i2c_data[10].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[10].reg_addr = OX03C_AGAIN_SPD_H;
    sns_state->regs_info[0].i2c_data[11].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[11].reg_addr = OX03C_AGAIN_SPD_L;

    // VTS related    be init to 0 ,error
    sns_state->regs_info[0].i2c_data[12].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[12].reg_addr = OX03C_VMAX_H;
    sns_state->regs_info[0].i2c_data[13].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[13].reg_addr = OX03C_VMAX_L;

    // preawb
    // ct
    sns_state->regs_info[0].i2c_data[14].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[14].reg_addr = OX03C_nCT_L;
    sns_state->regs_info[0].i2c_data[15].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[15].reg_addr = OX03C_nCT_H;
    // spd
    sns_state->regs_info[0].i2c_data[16].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[16].reg_addr = OX03C_SPD_B_GAIN_H;
    sns_state->regs_info[0].i2c_data[17].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[17].reg_addr = OX03C_SPD_B_GAIN_L;
    sns_state->regs_info[0].i2c_data[18].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[18].reg_addr = OX03C_SPD_R_GAIN_H;
    sns_state->regs_info[0].i2c_data[19].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[19].reg_addr = OX03C_SPD_R_GAIN_L;
    // hcg
    sns_state->regs_info[0].i2c_data[20].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[20].reg_addr = OX03C_HCG_B_GAIN_H;
    sns_state->regs_info[0].i2c_data[21].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[21].reg_addr = OX03C_HCG_B_GAIN_L;
    sns_state->regs_info[0].i2c_data[22].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[22].reg_addr = OX03C_HCG_R_GAIN_H;
    sns_state->regs_info[0].i2c_data[23].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[23].reg_addr = OX03C_HCG_R_GAIN_L;
    // lcg
    sns_state->regs_info[0].i2c_data[24].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[24].reg_addr = OX03C_LCG_B_GAIN_H;
    sns_state->regs_info[0].i2c_data[25].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[25].reg_addr = OX03C_LCG_B_GAIN_L;
    sns_state->regs_info[0].i2c_data[26].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[26].reg_addr = OX03C_LCG_R_GAIN_H;
    sns_state->regs_info[0].i2c_data[27].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[27].reg_addr = OX03C_LCG_R_GAIN_L;
    // vs
    sns_state->regs_info[0].i2c_data[28].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[28].reg_addr = OX03C_VS_B_GAIN_H;
    sns_state->regs_info[0].i2c_data[29].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[29].reg_addr = OX03C_VS_B_GAIN_L;
    sns_state->regs_info[0].i2c_data[30].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[30].reg_addr = OX03C_VS_R_GAIN_H;
    sns_state->regs_info[0].i2c_data[31].delay_frame_num = 0;
    sns_state->regs_info[0].i2c_data[31].reg_addr = OX03C_VS_R_GAIN_L;
    return;
}
    ...
    ot_eis_sns_state *sns_state)
{
    switch (sns_image_mode) {
        case OX03C_SENSOR_1280P_30FPS_LINEAR_MODE:
            sns_state->fl_std = OX03C_VMAX_1280P30_LINEAR;
            break;
        case OX03C_FULL_LINES_MAX_BUILT_IN_WDR:
            sns_state->fl_std = OX03C_VMAX_1280P30_BUILT_IN_WDR;
            break;
        default:
            sns_state->fl_std = OX03C_VMAX_1280P30_LINEAR;
            break;
...
static ot_s32 cmos_set_image_mode(ot_vi_pipe_id vi_pipe, const ot_eis_vi_sns_image_mode *sns_image_mode)
{
    ...
    for (i = 0; i < OX03C_MODE_BUTT; i++) {
        if (sns_image_mode->fps <= g_ox03c_mode_tbl[i].max_fps &&
            sns_image_mode->width <= g_ox03c_mode_tbl[i].width &&
            sns_image_mode->height <= g_ox03c_mode_tbl[i].height &&
            sns_state->wdr_mode == g_ox03c_mode_tbl[i].wdr_mode) {
            image_mode = (ox03c_res_mode)i;
            break;
        }
    }

    if (i >= OX03C_MODE_BUTT) {
        ox03c_err_mode_print(sns_image_mode, sns_state);
        return OT_FAILURE;
    }
...
static ot_void sensor_global_init(ot_vi_pipe_id vi_pipe)
{
    ...
    sns_state->sync_init = OT_FALSE;
    sns_state->img_mode  = OX03C_SENSOR_1280P_30FPS_LINEAR_MODE;
    sns_state->wdr_mode  = OT_EIS_WDR_MODE_NONE;
    sns_state->fl_std    = OX03C_VMAX_1280P30_LINEAR;
    sns_state->fl[0]     = OX03C_VMAX_1280P30_LINEAR;
    sns_state->fl[1]     = OX03C_VMAX_1280P30_LINEAR;
...
static ot_s32 sensor_ctx_init(ot_vi_pipe_id vi_pipe)
{
    ...
    ox03c_sensor_get_ctx(vi_pipe, sns_state_ctx);
    ...
    ox03c_sensor_set_ctx(vi_pipe, sns_state_ctx);
...
static ot_void sensor_ctx_exit(ot_vi_pipe_id vi_pipe)
{
    ...
    ox03c_sensor_reset_ctx(vi_pipe);

    return;
}

static ot_eis_vi_sns_register_func g_ox03c_register_to_vi_func = {
    .pfn_sns_init                = ox03c_init,
    .pfn_sns_exit                = ox03c_exit,
...
static ot_eis_vi_ae_sensor_register_func g_ox03c_register_to_ae_func = {
...
static ot_eis_vi_awb_sensor_register_func g_ox03c_register_to_awb_func = {
...
static ot_s32 sensor_register_callback(ot_vi_pipe_handle pipe_hdl)
{
    ...
    ret = ot_eis_vi_sensor_register_to_vi(pipe_hdl, &g_ox03c_register_to_vi_func, OX03C_ID);
    if (ret != OT_SUCCESS) {
        sns_err_trace("sensor register to vi failed!\n");
        goto free_sns_ctx;
    }

    ret = ot_eis_vi_sensor_register_to_ae(pipe_hdl, &g_ox03c_register_to_ae_func, OX03C_ID);
    if (ret != OT_SUCCESS) {
        sns_err_trace("sensor register to ae lib failed!\n");
        goto sns_unreg_to_vi;
    }

    ret = ot_eis_vi_sensor_register_to_awb(pipe_hdl, &g_ox03c_register_to_awb_func, OX03C_ID);
    if (ret != OT_SUCCESS) {
...
sns_unreg_to_ae:
    ot_eis_vi_sensor_unregister_to_ae(pipe_hdl, OX03C_ID);
sns_unreg_to_vi:
    ot_eis_vi_sensor_unregister_to_vi(pipe_hdl, OX03C_ID);
free_sns_ctx:
...
static ot_s32 sensor_unregister_callback(ot_vi_pipe_handle pipe_hdl)
{
    ...
    ret = ot_eis_vi_sensor_unregister_to_vi(pipe_hdl, OX03C_ID);
    if (ret != OT_SUCCESS) {
        sns_err_trace("sensor unregister callback function failed!\n");
        return ret;
    }
    ret = ot_eis_vi_sensor_unregister_to_ae(pipe_hdl, OX03C_ID);
    if (ret != OT_SUCCESS) {
        sns_err_trace("sensor unregister callback function to ae lib failed!\n");
        return ret;
    }

    ret = ot_eis_vi_sensor_unregister_to_awb(pipe_hdl, OX03C_ID);
    if (ret != OT_SUCCESS) {
...
static ot_s32 ox03c_set_bus_info(ot_vi_pipe_handle pipe_hdl, ot_eis_sns_bus_info *sns_bus_info)
{
    ot_s32 ret;
    ot_vi_pipe_id vi_pipe[OT_EIS_VI_PIPE_ID_NUM_MAX] = { 0 };
    ot_vi_pipe_id master_pipe_id = 0;
    ...
    memcpy_s(&g_ox03c_bus_info[master_pipe_id], sizeof(ot_eis_sns_bus_info), sns_bus_info, sizeof(ot_eis_sns_bus_info));
...
static ot_s32 ox03c_set_alg_default(ot_vi_pipe_handle pipe_hdl, ot_eis_vi_sns_alg_default *sns_alg_def)
{
    ot_s32 ret;
    ot_vi_pipe_id vi_pipe[OT_EIS_VI_PIPE_ID_NUM_MAX] = { 0 };
    ot_vi_pipe_id master_pipe_id = 0;
...
static ot_s32 ox03c_set_awb_default(ot_vi_pipe_handle pipe_hdl, ot_eis_vi_awb_sensor_default *sns_awb_def)
{
    ot_s32 ret;
    ot_vi_pipe_id vi_pipe[OT_EIS_VI_PIPE_ID_NUM_MAX] = { 0 };
    ot_vi_pipe_id master_pipe_id = 0;
...
static ot_s32 ox03c_set_reg_table(ot_vi_pipe_handle pipe_hdl, ot_eis_sns_reg_table *reg_table, ot_s32 table_cnt)
{
    ot_s32 ret;
    ot_vi_pipe_id vi_pipe[OT_EIS_VI_PIPE_ID_NUM_MAX] = { 0 };
    ot_vi_pipe_id master_pipe_id = 0;
...
ot_eis_sns_obj g_sns_ox03c_obj = {
    .pfn_sns_register              = sensor_register_callback,
    .pfn_sns_unregister            = sensor_unregister_callback,
    .pfn_sns_standby               = ox03c_standby,
    .pfn_sns_restart               = ox03c_restart,
    .pfn_sns_set_mirror_flip       = OT_NULL,
    .pfn_sns_set_blc_clamp         = ox03c_blc_clamp,
    .pfn_sns_set_bus_info          = ox03c_set_bus_info,
    .pfn_sns_set_init              = sensor_set_init,
    .pfn_sns_set_alg_default       = ox03c_set_alg_default,
    .pfn_sns_set_awb_default       = ox03c_set_awb_default,
    .pfn_sns_set_reg_table         = ox03c_set_reg_table,
};
