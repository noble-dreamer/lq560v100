...
#define MSENSOR_CMD_ADD_USER    _IOWR(MSENSOR_TYPE_MNG, IOC_NR_MSENSOR_MNG_ADD_USER,    ot_s32)
#define MSENSOR_CMD_DELETE_USER _IOWR(MSENSOR_TYPE_MNG, IOC_NR_MSENSOR_MNG_DELETE_USER, ot_s32)
#define MSENSOR_CMD_SEND_DATA   _IOW(MSENSOR_TYPE_MNG,  IOC_NR_MSENSOR_MNG_SEND_DATA,   ot_msensor_data)

#define MSENSOR_CMD_SYNC_TIME   _IOWR(MSENSOR_TYPE_MNG, IOC_NR_MSENSOR_MNG_SYNC_TIME,   ot_u64)
