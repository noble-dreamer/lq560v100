...
#define OT_SPI_IOC_RD_MODE          _IOR(OT_SPI_IOC_MAGIC, 1, ot_u8)
#define OT_SPI_IOC_WR_MODE          _IOW(OT_SPI_IOC_MAGIC, 1, ot_u8)

/* Read / Write SPI bit justification */
#define OT_SPI_IOC_RD_LSB_FIRST     _IOR(OT_SPI_IOC_MAGIC, 2, ot_u8)
#define OT_SPI_IOC_WR_LSB_FIRST     _IOW(OT_SPI_IOC_MAGIC, 2, ot_u8)

/* Read / Write SPI device word length (1..N) */
#define OT_SPI_IOC_RD_BITS_PER_WORD _IOR(OT_SPI_IOC_MAGIC, 3, ot_u8)
#define OT_SPI_IOC_WR_BITS_PER_WORD _IOW(OT_SPI_IOC_MAGIC, 3, ot_u8)

/* Read / Write SPI device default max speed hz */
#define OT_SPI_IOC_RD_MAX_SPEED_HZ  _IOR(OT_SPI_IOC_MAGIC, 4, ot_u32)
#define OT_SPI_IOC_WR_MAX_SPEED_HZ  _IOW(OT_SPI_IOC_MAGIC, 4, ot_u32)
