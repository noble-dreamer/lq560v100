...
#define AUTOCONF_TIMESTAMP "2024-01-04 11:41:04 CST"

/*
 * General Setup
 */
#define CONFIG_LQ560V100PLUS 1
#define CONFIG_OT_CHIP_TYPE 0x560b100
#define CONFIG_OT_ARCH "lq560v100plus"
#define CONFIG_SUBCHIP_LQ560V100PLUS 1
#define CONFIG_OT_SUBARCH "lq560v100plus"
#define CONFIG_OT_SUBCHIP_TYPE 0x560b100
#define CONFIG_SMP 1
...
#define CONFIG_KERNEL_AARCH64_otv02_LINUX_GNU 1
#define CONFIG_OT_CROSS "aarch64-otv02-linux-gnu-"
#define CONFIG_LIBC_TYPE "glibc"
#define CONFIG_KERNEL_BIT "KERNEL_BIT_64"
#define CONFIG_USER_AARCH64_otv02_LINUX_GNU 1
#define CONFIG_OT_CROSS_LIB "aarch64-otv02-linux-gnu-"
 ...
 * media vrb config
 */
#define CONFIG_OT_VRB_EXTPOOL_SUPPORT 1
#define CONFIG_OT_VRB_SUPPLEMENT_MASK_SUPPORT 1
 ...
 * media oge config
 */
#define CONFIG_OT_OGE_SUPPORT 1
...
#define CONFIG_OT_VENC_VPROC_AUTO_SUPPORT 1
...
#define CONFIG_OT_VO_VPROC_AUTO 1
 ...
 * media vproc config
 */
#define CONFIG_OT_VPROC_SUPPORT 1

/*
 * vproc online config
 */
#define CONFIG_OT_VPROC_VIPROC_VPROC_ONLINE_SUPPORT 1
#define CONFIG_OT_VPROC_ONLINE_SUPPORT 1

/*
 * vproc 3dnr config
 */
#define CONFIG_OT_VPROC_3DNR_SUPPORT 1
#define CONFIG_OT_VPROC_3DNR_GAMMA_SUPPORT 1
#define CONFIG_OT_VPROC_AUTO_SUPPORT 1
 ...
 */
#define CONFIG_OT_VPROC_CORNER_RECT_SUPPORT 1
#define CONFIG_OT_VPROC_MOSAIC_SUPPORT 1

/*
 * vproc chn rgn config
 */
#define CONFIG_OT_VPROC_RGN_ON_CHN_SUPPORT 1
#define CONFIG_OT_VPROC_COVER_SUPPORT 1
#define CONFIG_OT_VPROC_COVER_RECT_SUPPORT 1
#define CONFIG_OT_VPROC_COVER_HOLLOW_SUPPORT 1
#define CONFIG_OT_VPROC_2SCALE_SUPPORT 1
#define CONFIG_OT_VPROC_VGS_GRP_SUPPORT 1
#define CONFIG_OT_VPROC_BUFFER_REUSE_SUPPORT 1
#define CONFIG_OT_VPROC_LOW_DELAY_SUPPORT 1
#define CONFIG_OT_VPROC_EXT_CHN_SUPPORT 1
#define CONFIG_OT_VPROC_CHN_CROP_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_CROP_SIZE_PRIOR_SUPPORT 1
#define CONFIG_OT_VPROC_CHN_STRIDE_ALIGN_SUPPORT 1
#define CONFIG_OT_VPROC_CHN_LBA_SUPPORT 1
#define CONFIG_OT_VPROC_MCF_SUPPORT 1

/*
 * vproc gdc config
 */
#define CONFIG_OT_VPROC_GDC_SUPPORT 1
#define CONFIG_OT_VPROC_FISHEYE_LMF_SUPPORT 1

/*
 * vproc grp gdc config
 */
#define CONFIG_OT_VPROC_GRP_GDC_SUPPORT 1
#define CONFIG_OT_VPROC_OUT_LUT_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_LDC_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_SPREAD_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_FISHEYE_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_ROTATION_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_PMF_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_FOV_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_LUT_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_ZME_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_STITCH_SUPPORT 1
#define CONFIG_OT_VPROC_GRP_STITCH_BLEND_SUPPORT 1

/*
 * vproc chn gdc config
 */
#define CONFIG_OT_VPROC_NODE_CANCEL_SUPPORT 1
 ...
 * media gfb Config
 */
#define CONFIG_OT_GFB_SUPPORT 1
#define CONFIG_GFB_DPU_V3 1
/*
 * media snap Config
 */
 ...
 * media avp Config
 */
#define CONFIG_OT_AVP_SUPPORT 1
#define CONFIG_OT_AVP_CVE 1
#define CONFIG_OT_AVP_CVE_CSC 1
#define CONFIG_OT_AVP_CVE_FILTER_AND_CSC 1
#define CONFIG_OT_AVP_CVE_NCC 1
#define CONFIG_OT_AVP_CVE_LBP 1
#define CONFIG_OT_AVP_CVE_NORM_GRAD 1
#define CONFIG_OT_AVP_CVE_ST_CANDI_CORNER 1
#define CONFIG_OT_AVP_CVE_RESIZE 1
#define CONFIG_OT_AVP_CVE_PERSP_TRANS 1
#define CONFIG_OT_AVP_CVE_KCF 1
#define CONFIG_OT_AVP_CVE_HOG 1
#define CONFIG_OT_AVP_MD 1
#define CONFIG_OT_AVP_NPU_V2R2 1
#define CONFIG_OT_AVP_DPU_RECT 1
#define CONFIG_OT_AVP_DPU_MATCH 1
...
/*
 * media ssmr agent config
 */
#define CONFIG_OT_SSMR_AGENT_SUPPORT 1
