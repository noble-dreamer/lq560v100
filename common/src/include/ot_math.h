 ...
 * SPAN(ot_u32, 100, 200) is 200 - 100 = 100
 * SPAN(ot_u32, 200, 100) is 0xFFFFFFFF - 200 + 100
 * SPAN(ot_u64, 200, 100) is 0xFFFFFFFFFFFFFFFF - 200 + 100
 */
...
__inline static ot_bool is_little_end(void)
{
    union end_test_u {
        ot_char test[4];
        ot_u32 test_full;
    ...
    return (end_test.test_full > 0x01020304) ? (OT_TRUE) : (OT_FALSE);
}
 ...
 */
__inline static ot_void rgb_to_yc(ot_u16 r, ot_u16 g, ot_u16 b, ot_u16 *y, ot_u16 *cb, ot_u16 *cr)
{
    /* Y */
    *y = (ot_u16)((((r * 66 + g * 129 + b * 25) >> 8) + 16) << 2);

    /* cb */
    *cb = (ot_u16)(((((b * 112 - r * 38) - g * 74) >> 8) + 128) << 2);

    /* cr */
    *cr = (ot_u16)(((((r * 112 - g * 94) - b * 18) >> 8) + 128) << 2);
}

__inline static ot_u32 rgb_to_yuv(ot_u32 rgb)
{
    ot_u16 y, u, v;
...
__inline static ot_void rgb_to_yc_full(ot_u16 r, ot_u16 g, ot_u16 b, ot_u16 *y, ot_u16 *cb, ot_u16 *cr)
{
    ot_u16 y_tmp, cb_tmp, cr_tmp;

    y_tmp = (ot_u16)(((r * 76 + g * 150 + b * 29) >> 8) * 4);
    cb_tmp = (ot_u16)(clip_min(((((b * 128 - r * 43) - g * 84) >> 8) + 128), 0) * 4);
    cr_tmp = (ot_u16)(clip_min(((((r * 128 - g * 107) - b * 20) >> 8) + 128), 0) * 4);
...
__inline static ot_u32 rgb_to_yuv_full(ot_u32 rgb)
{
    ot_u16 y, u, v;
...
__inline static ot_void yc_full_to_rgb(ot_u16 y, ot_u16 cb, ot_u16 cr, ot_u16 *r, ot_u16 *g, ot_u16 *b)
{
    ot_s16 r_tmp, g_tmp, b_tmp;

    r_tmp = (y >> 2) + ((359 * (cr - 512)) >> 10);
    g_tmp = (y >> 2) - (((88 * (cb - 512) + 182 * (cr - 512))) >> 10);
    b_tmp = (y >> 2) + ((454 * (cb - 512)) >> 10);

    *r = MAX2(MIN2(r_tmp, 255), 0);
    *g = MAX2(MIN2(g_tmp, 255), 0);
    *b = MAX2(MIN2(b_tmp, 255), 0);
}

__inline static ot_u32 yuv_full_to_rgb(ot_u32 yuv)
{
    ot_u16 r, g, b;

    yc_full_to_rgb(YUV_Y(yuv), YUV_U(yuv), YUV_V(yuv), &r, &g, &b);
 ...
 * rgbfull to yuv601limit
 */
__inline static ot_void rgb_to_yc_8bit(ot_u8 r, ot_u8 g, ot_u8 b, ot_u8 *y, ot_u8 *cb, ot_u8 *cr)
{
    /* Y */
    *y = (ot_u8)(((r * 66 + g * 129 + b * 25) >> 8) + 16);

    /* cb */
    *cb = (ot_u8)((((b * 112 - r * 38) - g * 74) >> 8) + 128);

    /* cr */
    *cr = (ot_u8)((((r * 112 - g * 94) - b * 18) >> 8) + 128);
}

__inline static ot_u32 rgb_to_yuv_8bit(ot_u32 rgb)
{
    ot_u8 y, u, v;
...
/* rgbfull to yuv601full */
__inline static ot_void rgb_to_yc_full_8bit(ot_u8 r, ot_u8 g, ot_u8 b, ot_u8 *y, ot_u8 *cb, ot_u8 *cr)
{
    ot_s16 y_tmp, cb_tmp, cr_tmp;
...
__inline static ot_u32 rgb2_yuv_full_8_bit(ot_u32 rgb)
{
    ot_u8 y, u, v;
 ...
 */
typedef struct {
    ot_u32 full_fps; /* full frame rate    */
    ot_u32 target_fps; /* target frame rate  */
    ot_u32 frame_key; /* update key frame   */
} fps_ctrl;

__inline static ot_void init_fps(fps_ctrl *frame_ctrl, ot_u32 full_fps, ot_u32 tag_fps)
{
...
__inline static ot_bool do_fps_ctrl(fps_ctrl *frame_ctrl)
{
...
__inline static ot_u32 get_low_addr(ot_phys_addr_t phys_addr)
{
    return (ot_u32)phys_addr;
}

__inline static ot_u32 get_high_addr(ot_phys_addr_t phys_addr)
{
    ot_u32 low_width = 32; /* 32bit low addr */
    return (sizeof(phys_addr) > (low_width / 8)) ? (ot_u32)(phys_addr >> low_width) : 0; /* 8 bits per byte */
}
